                    ...
                    members.forEach(function(m) {
                        ...
                        if (memberMarkers[m.id]) {
                            ...
                            var icon = L.divIcon({
                                ...
                                html: '<div style="background-color: #10B981; width: 14px; height: 14px; border-radius: 50%; border: 2px solid white;"><span style="color: white; font-size: 8px; font-weight: bold; position: absolute; top: 16px; background: rgba(0,0,0,0.5); padding: 2px 4px; border-radius: 4px; white-space: nowrap;">'+m.name+'</span></div>',
                                iconSize: [14, 14],
                                iconAnchor: [7, 7]
                            });
