...
const SettingsScreen: React.FC<Props> = () => {
    ...
    // Modals
    const [idCardVisible, setIdCardVisible] = useState<boolean>(false);
    ...
    const MenuItem: React.FC<MenuItemProps> = ({ icon, title, subtitle, showChevron = true, rightElement, onPress }) => (
...
const styles = StyleSheet.create({
    ...
    logoIcon: { width: 36, height: 36, backgroundColor: '#FFD700', borderRadius: 18, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
    logoText: { color: '#FFD700', fontSize: 20, fontWeight: 'bold', letterSpacing: 0.5 },
    logoSubText: { color: '#9CA3AF', fontSize: 12, letterSpacing: 1 },
    sectionHeader: { color: '#6B7280', fontSize: 12, fontWeight: 'bold', marginBottom: 10, marginTop: 10, letterSpacing: 1 },
    card: { backgroundColor: '#161925', borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#1F2937', marginBottom: 20 },
    menuItem: { flexDirection: 'row', alignItems: 'center', padding: 15 },
    menuIconContainer: { width: 32, alignItems: 'center', justifyContent: 'center', marginRight: 10 },
    menuTextContainer: { flex: 1 },
    menuTitle: { color: 'white', fontSize: 14, fontWeight: '500' },
    menuSubtitle: { color: '#6B7280', fontSize: 12, marginTop: 2 },
    menuRight: { flexDirection: 'row', alignItems: 'center' },
    divider: { height: 1, backgroundColor: '#1F2937', marginLeft: 50 },
    avatarContainer: { marginRight: 15 },
    headerProfileBtn: { position: 'relative' },
    headerAvatar: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#374151', alignItems: 'center', justifyContent: 'center', borderWidth: 1.5, borderColor: '#FFD700' },
    headerAvatarText: { color: '#000', fontWeight: '900', fontSize: 14 },
    warningDot: { position: 'absolute', top: 0, right: 0, width: 10, height: 10, borderRadius: 5, backgroundColor: '#EF4444', borderWidth: 2, borderColor: '#0F111A' },
    warningBanner: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFD700', padding: 12, borderRadius: 12, marginBottom: 20, gap: 10 },
    warningBannerText: { flex: 1, color: '#000', fontSize: 12, fontWeight: 'bold' },
    profileCard: { backgroundColor: '#161925', borderRadius: 16, padding: 20, borderWidth: 1, borderColor: '#1F2937', marginBottom: 25 },
    profileCardMain: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
    summaryAvatar: { width: 60, height: 60, borderRadius: 30, alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFD700' },
    summaryAvatarText: { color: '#000', fontSize: 22, fontWeight: 'bold' },
    profileDetails: { marginLeft: 15, flex: 1 },
    profileName: { color: 'white', fontSize: 18, fontWeight: 'bold' },
    profileVehicle: { color: '#9CA3AF', fontSize: 13, marginTop: 4 },
    incompleteLabel: { backgroundColor: 'rgba(239, 68, 68, 0.1)', alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 4, marginTop: 6, borderWidth: 0.5, borderColor: '#EF4444' },
    incompleteText: { color: '#EF4444', fontSize: 10, fontWeight: 'bold' },
    editProfileBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#1F2937', paddingVertical: 10, borderRadius: 10, gap: 8, borderWidth: 1, borderColor: '#374151' },
    editProfileText: { color: '#FFD700', fontSize: 12, fontWeight: 'bold' },
    avatar: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#374151', alignItems: 'center', justifyContent: 'center', borderWidth: 2, borderColor: '#FFD700' },
    avatarText: { color: 'white', fontWeight: 'bold', fontSize: 16 },
    userBadge: { position: 'absolute', bottom: -5, alignSelf: 'center', backgroundColor: '#374151', paddingHorizontal: 6, borderRadius: 10, borderWidth: 1, borderColor: '#1F2937' },
    userBadgeText: { color: '#FFD700', fontSize: 8, fontWeight: 'bold' },
    segmentControl: { flexDirection: 'row', backgroundColor: '#1F2937', borderRadius: 6, padding: 2 },
    segmentBtn: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 4 },
    segmentBtnActive: { backgroundColor: '#374151' },
    segmentText: { color: '#6B7280', fontSize: 12, fontWeight: 'bold' },
    segmentTextActive: { color: '#FFD700' },
    logoutBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', padding: 15, backgroundColor: 'rgba(239, 68, 68, 0.1)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(239, 68, 68, 0.3)', marginTop: 10, marginBottom: 30 },
    logoutText: { color: '#EF4444', fontWeight: 'bold', fontSize: 14 },
    footer: { alignItems: 'center', marginBottom: 30 },
    versionText: { color: '#4B5563', fontSize: 12, marginBottom: 5 },
    footerLinks: { flexDirection: 'row', gap: 20 },
    linkText: { color: '#6B7280', fontSize: 12 },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.8)', justifyContent: 'center', alignItems: 'center', padding: 20 },
    modalContent: { backgroundColor: '#161925', borderRadius: 16, padding: 20, width: '100%', maxWidth: 400, borderWidth: 1, borderColor: '#374151' },
    modalHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 },
    modalTitle: { color: 'white', fontSize: 18, fontWeight: 'bold' },
    saveButton: { backgroundColor: '#FFD700', borderRadius: 12, padding: 15, alignItems: 'center', marginTop: 10 },
    saveButtonText: { color: 'black', fontWeight: 'bold' },
    supportText: { color: '#D1D5DB', fontSize: 16, lineHeight: 24, marginBottom: 20 },
});
